...
<head>
    ...
    <link rel="stylesheet" href="css/coordonnes.css">
...
<body>
    ...
    <!---------------------------------------------- Mes contacts ------------------------------------------->
    <div class="card border-success mb-3" style="max-width: 18rem;margin: auto;border-color:  black !important;">
      <div class="card-header bg-transparent border-success" style="border-color:  black !important; text-align: center;" >Mes coordonnées</div>
      <div class="card-body text-success" style="color:  black !important;">
        <p class="card-title" style="color:  black !important;"> 	&#x1F4E7;mail : Idris1390@gmail.com</p>
        <p class="card-text"> &#x1F4F1;Numero : +33 07-67-43-05-75</p>
      </div>
      <div class="card-footer bg-transparent border-success" style="border-color:  black !important;">Merci de l'attention que vous me portez</div>
    </div>
